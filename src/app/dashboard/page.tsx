    ...
    <main className="min-h-screen bg-slate-50 px-4 py-6 sm:px-6 sm:py-10">
      <div className="mx-auto max-w-5xl">
        ...
        <section className="mt-10 grid gap-5 md:grid-cols-2">
           <Link className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition hover:-translate-y-0.5 hover:border-emerald-300 sm:p-6" href="/profile">
           ...
           <div className="rounded-2xl border border-dashed border-slate-300 bg-white/70 p-4 sm:p-6">
